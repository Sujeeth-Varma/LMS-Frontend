  ...
  if (isAuthenticated) {
    return (
      <div className="min-h-screen bg-background flex items-center justify-center p-4">
        <div className="bg-white p-8 rounded-lg shadow-xl max-w-md w-full border-t-4 border-primary">
          <div className="text-center">
            ...
            <h2 className="text-2xl font-bold text-text mb-2">Welcome to LMS</h2>
            <p className="text-text-secondary mb-6">Hello, <span className="text-primary font-semibold">{user}</span>!</p>
            <button
              onClick={handleLogout}
              className="w-full bg-primary hover:bg-secondary text-white font-medium py-2.5 px-4 rounded-md transition-colors duration-200"
            >
              Sign Out
            </button>
          </div>
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="bg-white p-6 sm:p-8 rounded-lg shadow-md max-w-md w-full">
        <div className="text-center mb-6">
          ...
          <p className="text-sm text-text-secondary">Sign in to your LMS account</p>
        </div>
